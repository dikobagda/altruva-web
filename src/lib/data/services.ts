...
import { HeartPulse, Droplets, Star, Sparkles, Zap, Sun, Dna, Microscope, BookOpen, Layers, Info, Shield } from 'lucide-react';
...
export const services: Service[] = [
  ...
  },
  {
    ...
    category: 'Facial',
    Icon: Droplets,
    imageSrc: '/images/services/HydraGlow.png',
  ...
  },
  {
    ...
    Icon: Droplets,
    imageSrc: '/images/services/glacier.png',
  ...
  },
  {
    ...
    category: 'Prejuvenation',
    Icon: Shield,
    imageSrc: '/images/services/dnarepair.png',
  ...
  },
  {
    ...
    category: 'Prejuvenation',
    Icon: Sun,
    imageSrc: '/images/services/darkspot.png',
  ...
  },
  {
    ...
    category: 'Prejuvenation',
    Icon: HeartPulse,
    imageSrc: '/images/services/bioprf.jpg',
  ...
  },
  {
    ...
    category: 'Prejuvenation',
    Icon: Sparkles,
    imageSrc: '/images/services/clarifypeel.webp',
  ...
  },
  {
    ...
    category: 'Prejuvenation',
    Icon: Star,
    imageSrc: '/images/services/koreanpeel.png',
  ...
  },
  {
    ...
    category: 'Prejuvenation',
    Icon: Zap,
    imageSrc: '/images/services/lumilaser.png',
  ...
  },
  {
    ...
    whatIsIt: {
      title: { en: 'How It Works', id: 'Cara Kerjanya' },
      description: {
        en: `<p>A.R.T. Lift Lite uses precision ultrasound energy (<a href="https://sofwave.com/" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">Sofwave</a>) to activate your skin's natural regenerative power. Focused beams of ultrasound energy reach the mid-dermis, heating tissue at just the right depth to stimulate fibroblasts—without damaging the skin surface. The gentle heat activates neocollagenesis, the body's natural process of forming fresh collagen and elastin. With regenerative mapping by dr. Aldisa, each shot is planned to follow your unique fat pads, ligament structures, and collagen-rich zones to optimize long-term firming while preserving natural beauty.</p>`,
        id: `<p>A.R.T. Lift Lite menggunakan energi ultrasound presisi (<a href="https://sofwave.com/" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">Sofwave</a>) untuk mengaktifkan kekuatan regeneratif alami kulit Anda. Sinar ultrasound yang terfokus mencapai pertengahan dermis, memanaskan jaringan pada kedalaman yang tepat untuk merangsang fibroblas—tanpa merusak permukaan kulit. Panas yang lembut mengaktifkan neokollagenesis, proses alami tubuh untuk membentuk kolagen dan elastin baru. Dengan pemetaan regeneratif oleh dr. Aldisa, setiap tembakan direncanakan untuk mengikuti bantalan lemak, struktur ligamen, dan zona kaya kolagen unik Anda untuk mengoptimalkan pengencangan jangka panjang sambil menjaga kecantikan alami.</p>`
      }
    },
    howItDiffers: {
  ...
  },
  {
    ...
    category: 'Prejuvenation',
    Icon: Zap,
    imageSrc: '/images/services/lumirf.png',
  ...
  },
  {
    ...
    category: 'Prejuvenation',
    Icon: Sparkles,
    imageSrc: '/images/services/FaceModulatorHalfDose.webp',
  ...
  },
  {
    ...
    category: 'Prejuvenation',
    Icon: Star,
    imageSrc: '/images/services/dermal-fillers.webp',
  ...
  // --- Rejuvenation (> 40) ---
  {
    ...
    Icon: HeartPulse,
    imageSrc: '/images/services/stem-cell.jpg',
  ...
  },
  {
    ...
    category: 'Rejuvenation',
    Icon: Shield,
    imageSrc: '/images/services/dnarepairprov2.jpg',
  ...
  },
  {
    ...
    category: 'Rejuvenation',
    Icon: Shield,
    imageSrc: '/images/services/dnarepaireye.png',
  ...
  },
  {
    ...
    category: 'Rejuvenation',
    Icon: Droplets,
    imageSrc: '/images/services/aminobooster.webp',
  ...
  },
  {
    ...
    category: 'Rejuvenation',
    Icon: Sun,
    imageSrc: '/images/services/mela-booster.webp',
  ...
  },
  {
    ...
    category: 'Rejuvenation',
    Icon: Sparkles,
    imageSrc: '/images/services/RadiantAdvancedPeel.png',
  ...
  },
  {
    ...
    category: 'Rejuvenation',
    Icon: Zap,
    imageSrc: '/images/services/regenerativelaser.png',
  ...
  },
  {
    ...
    category: 'Rejuvenation',
    Icon: Zap,
    imageSrc: '/images/services/fractio.png',
  ...
  },
  {
    ...
    category: 'Rejuvenation',
    Icon: Zap,
    imageSrc: '/images/services/liftpro.png',
    ...
    whatIsIt: {
      ...
      description: {
        en: `<ul class="list-disc pl-5 mt-2 space-y-2" style="padding-left: 40px;">
        <li><strong><a href="https://sofwave.com/" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">Sofwave</a> Technology + Anatomical Mapping:</strong> Utilizing SUPERB™ ultrasound energy, the treatment delivers targeted heating to collagen-rich zones, following dr. Aldisa's anatomical blueprint of facial ligaments, fat compartments, and dermal layers.</li>
        ...
        id: `<ul class="list-disc pl-5 mt-2 space-y-2" style="padding-left: 40px;">
        <li><strong>Teknologi <a href="https://sofwave.com/" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">Sofwave</a> + Pemetaan Anatomis:</strong> Memanfaatkan energi ultrasound SUPERB™, perawatan memberikan pemanasan yang ditargetkan ke zona kaya kolagen, mengikuti cetak biru anatomi dr. Aldisa tentang ligamen wajah, kompartemen lemak, dan lapisan dermal.</li>
  ...
  },
  {
    ...
    category: 'Rejuvenation',
    Icon: Sparkles,
    imageSrc: '/images/services/cocktail.webp',
  ...
  },
  {
    ...
    category: 'Rejuvenation',
    Icon: Star,
    imageSrc: '/images/services/dermal-fillers-pro.jpeg',
  ...
  },
  {
    ...
    category: 'Rejuvenation',
    Icon: Sparkles,
    imageSrc: '/images/services/fulldose.png',
  ...
  // --- Body Treatments ---
  {
    ...
    category: 'Body',
    Icon: Zap,
    imageSrc: '/images/services/neocurve.png',
  ...
  },
  {
    ...
    category: 'Body',
    Icon: Droplets,
    imageSrc: '/images/services/LipoElixir.png',
  ...
  },
  {
    ...
    whatIsIt: {
      ...
      description: {
        en: `<ul class="list-disc pl-5 mt-2 space-y-2" style="padding-left: 40px;">
          <li><strong>Radiofrequency Energy:</strong> Controlled RF waves gently heat the dermis and subdermal tissues, stimulating fibroblasts to increase collagen and elastin synthesis — critical for firm, elastic, youthful-looking skin.</li>
        ...
        id: `<ul class="list-disc pl-5 mt-2 space-y-2" style="padding-left: 40px;">
          <li><strong>Energi Frekuensi Radio:</strong> Gelombang RF yang terkontrol dengan lembut memanaskan dermis dan jaringan subdermal, merangsang fibroblas untuk meningkatkan sintesis kolagen dan elastin — penting untuk kulit yang kencang, elastis, dan tampak muda.</li>
  ...
  },
  {
    ...
    category: 'Body',
    Icon: Star,
    imageSrc: '/images/services/coolsculpting.webp',
  ...
  // --- Hair Treatments ---
  {
    ...
    category: 'Hair',
    Icon: Microscope,
    imageSrc: '/images/services/micrograft.png',
  ...
  },
  {
    ...
    category: 'Hair',
    Icon: HeartPulse,
    imageSrc: '/images/services/prf.png',
  ...
  },
  {
    ...
    category: 'Hair',
    Icon: Droplets,
    imageSrc: '/images/services/hairbooster.jpg',
